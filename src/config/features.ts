...
/** Mainnet single-leg buy pilot — disabled by default; enable via VITE_ENABLE_MAINNET_EXECUTION=true */
export const ENABLE_MAINNET_EXECUTION = import.meta.env.VITE_ENABLE_MAINNET_EXECUTION === 'true'
